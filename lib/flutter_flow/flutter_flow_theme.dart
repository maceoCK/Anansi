...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF800080);
  ...
  late Color accent2 = const Color(0xFF00B0FF);
  late Color accent3 = const Color(0xFFFFD740);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF1C1C1C);
  late Color secondary = const Color(0xFF6B006B);
  late Color tertiary = const Color(0xFF262626);
  ...
  late Color accent1 = const Color(0xFFF536A0);
  late Color accent2 = const Color(0xFF00A1E7);
  late Color accent3 = const Color(0xFFFFC72C);
  late Color accent4 = const Color(0xFF7CB342);
  late Color success = const Color(0xFF43A047);
  late Color warning = const Color(0xFFFFA000);
  late Color error = const Color(0xFFF4511E);
